...
var PubSubAsyncIterator = (function () {
    ...
    PubSubAsyncIterator.prototype.subscribeAll = function () {
        ...
        if (!this.subscriptionIds) {
            this.subscriptionIds = Promise.all(this.eventsArray.map(function (eventName) {
                return _this.pubsub.subscribe(eventName, _this.pushValue.bind(_this), _this.options);
            }));
        }
